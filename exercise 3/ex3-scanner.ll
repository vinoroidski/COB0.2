 ...
 * See also ex3-parser.yy for the parser (grammar)
 * (yacc/bison input).
 *
 ***********************/
...
%{
  typedef yy::ex3xx_parser::token token;
%}
	...
	/* Operators! First, single character operators +, -, * and /
         ...
         */
[-+*/]   return yy::ex3xx_parser::token_type (yytext[0]);
